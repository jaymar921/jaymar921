...
<a href="https://jayharronabejar.vercel.app">
  <img src="https://github.com/jaymar921/jaymar921/blob/main/cover_img.jpg" width="100%" />
</a>
...
ask_me_about: ["ASP.NET", "React/Next.js internals", "CI/CD pipelines", "Home DIY projects"]
```
...
[![My Skills](https://skillicons.dev/icons?i=react,nextjs,tailwind,js,dotnet,cs,nodejs,express,py,rabbitmq,azure,docker,git,github&perline=7)](https://skillicons.dev)
...
| **Backend** | .NET, C#, Node.js, Express, Python, RabbitMQ |
